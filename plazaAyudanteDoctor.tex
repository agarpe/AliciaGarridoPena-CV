...
\makerubric{details}
\textbf{
\huge{1. Formación académica y docente\\}}
{\color{gray}{\large\textit{1.1 Titulaciones obtenidas, teniendo en cuenta el grado de afinidad.}}}

\makerubric{educacion}

{\color{gray}{\large\textit{1.3. Cursos de formación recibidos (docencia e investigación).}}}
